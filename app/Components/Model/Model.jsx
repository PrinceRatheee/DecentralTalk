      ...
      <div className={Style.Model_box}>
        ...
        <div className={Style.Model_box_right}>
...

          {
            ...
            <div className={Style.Model_bos_right_name_info}>
              <Image src={images.username} alt="user" width={30} height={30} />
              <input type="text " placeholder="your name" onChange={(e)=>setName(e.target.value)}/>
            </div>
            <div className={Style.Model_bos_right_name_info}>
              <Image src={images.account} alt="user" width={30} height={30} />
              <input type="text " placeholder={accountAddress || "Enter your address"} onChange={(e)=>setAccountAddress(e.target.value)}/>
            </div>
